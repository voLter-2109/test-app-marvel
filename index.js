/*! For license information please see main.3970ca9e.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
        ...
        var Vl = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (l.payload = t),
              ...
              null !== (t = Rl(e, l, a)) && (ns(t, e, a, r), Fl(t, e, a));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (a.tag = 2),
              ...
              null !== (t = Rl(e, a, r)) && (ns(t, e, r, n), Fl(t, e, r));
          },
        };
        ...
        function Wl(e, t, n, r) {
          ...
          "object" === typeof l && null !== l
            ? (a.context = El(l))
            : ((l = za(t) ? ja : Pa.current), (a.context = Ta(e, l))),
        ...
        function vs(e, t) {
          ...
          if ((kl(), (Pu = n), (Eu.current = r), null !== ju))
            throw Error(l(261));
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 === (32768 & t.flags))) {
              if (null !== (n = qi(n, t, zu))) return void (ju = n);
            } else {
              if (null !== (n = Ki(n, t)))
        ...
        function Rs(e, t, n, r, a, o) {
          ...
          if (((r = e), "function" === typeof e)) zs(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case j:
                return (
                  ((e = Ts(19, n, t, a)).elementType = j), (e.lanes = o), e
                );
              case O:
                return Ms(n, a, o, t);
              default:
        ...
        function Hs(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = Rl(a, t, o)) && (ns(e, a, o, l), Fl(e, a, o)),
            o
          );
        }
        function Ws(e) {
    ...
    (function () {
      ...
      var y = i(function e() {
          ...
          r(this, e),
            ...
            (this._apiKey = "apikey=4f23b9b23bbb5dd879a4772e4d4dce6d"),
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          t.getResource(
                            ""
                              .concat(t._apiBase, "?limit=2&offset=")
                              .concat(n, "&")
                              .concat(t._apiKey)
                          )
                        );
                      case 3:
                        return (
                          ...
                          e.abrupt(
                            "return",
                            r.data.results.map(t._transformCharacter)
                          )
                        );
                      case 5:
                      case "end":
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 2:
                          return (
                            ...
                            e.abrupt(
                              "return",
                              t._transformCharacter(r.data.results[0])
                            )
                          );
                        case 4:
                        case "end":
        ...
        b = y,
        w = n.p + "static/media/error.42292aa12b6bc303ce99.gif",
        k = function () {
          return (0, p.jsx)("img", {
            src: w,
            alt: "erre",
        ...
        x = n.p + "static/media/mjolnir.61f31e1809f12183a524.png",
        S = function () {
          return (0, p.jsxs)("svg", {
        ...
        _ = (function (e) {
          ...
          function n(e) {
            ...
            return (
              r(this, n),
              ((a = t.call(this, e)).onCharLoaded = function (e) {
                a.setState({ char: e, loading: !1, errorRepeat: 1, error: !1 });
              }),
              (a.onError = function () {
                if (
                  (a.setState({ errorRepeat: a.state.errorRepeat + 1 }),
                  a.state.errorRepeat >= 2)
                )
                  return a.setState({ error: !0, loading: !1 });
                a.updateChar();
              }),
              (a.updateChar = function () {
                a.setState({ error: !1, loading: !0 });
                var e = Math.floor(1643 * Math.random() + 1009146);
                a.marvelService
                  .getCharacter(e)
                  .then(a.onCharLoaded)
                  .catch(a.onError);
              }),
              (a.state = { char: {}, loading: !0, errorRepeat: 1, error: !1 }),
              (a.marvelService = new b()),
              a
            );
          }
          return (
                      ...
                      (0, p.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, p.jsx)("button", {
                            ...
                            onClick: function () {
                              e.setState({ errorRepeat: 1 }), e.updateChar();
                            },
        ...
        E = function (e) {
          var t = e.char,
            ...
            i = { objectFit: "cover" };
          return (
            a.search(/image_not_available/i) && (i = { objectFit: "contain" }),
            (0, p.jsxs)("div", {
      ...
      var L = (function (e) {
          ...
          function n(e) {
            ...
            return (
              r(this, n),
              ((a = t.call(this, e)).onRequest = function (e) {
                a.onCharListLoading(),
                  a.marvelService
                    .getAllCharacters(e)
                    .then(a.onCharListLoaded)
                    .catch(a.onError);
              }),
              (a.onCharListLoading = function () {
                a.setState({ newItemLoading: !0 });
              }),
              (a.onCharListLoaded = function (e) {
                var t = !1;
                e.length < 2 && (t = !0),
              ...
              (a.focusCharItem = function (e, t) {
                a.itemsRef.forEach(function (e) {
                  e.classList.remove("char__item_selected");
                }),
                  a.props.onCharSelected(e),
                  a.itemsRef[t].classList.add("char__item_selected");
              }),
              (a.setFocusCharItems = function (e) {
                a.itemsRef.push(e);
              }),
              (a.state = {
                charList: [],
                ...
                value: function (e) {
                  var t = this,
                    n = e.map(function (e, n) {
                      var r = { objectFit: "cover" };
                      return (
                        e.thumbnail.search(/image_not_available/i) &&
                          (r = { objectFit: "contain" }),
                        (0, p.jsxs)(
                          "li",
                          {
                            ref: t.setFocusCharItems,
                            tabIndex: 0,
                            className: "char__item",
                            onClick: function () {
                              t.focusCharItem(e.id, n);
                            },
                ...
                children: [
                  (0, p.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, p.jsx)("div", { className: "pulse skeleton__mini" }),
                    ],
                  }),
                  (0, p.jsx)("div", { className: "pulse skeleton__block" }),
                  (0, p.jsx)("div", { className: "pulse skeleton__block" }),
                  (0, p.jsx)("div", { className: "pulse skeleton__block" }),
                ],
              }),
        ...
        z = (function (e) {
          ...
          function n(e) {
            ...
            return (
              r(this, n),
              ((a = t.call(this, e)).updateChar = function () {
                var e = a.props.charId;
                e &&
                  (a.onCharLoading(),
                  a.marvelService
                    .getCharacter(e)
              ...
              (a.onCharLoading = function () {
                a.setState({ loading: !0 });
              }),
              (a.onError = function () {
                a.setState({ loading: !1, error: !0 });
              }),
              (a.state = { char: null, loading: !1, error: !1 }),
              (a.marvelService = new b()),
              a
            );
          }
              ...
              },
              {
                ...
                value: function () {
                  var e = this.state,
                    ...
                    n = e.loading,
                    r = e.error,
                    a = t || n || r ? null : (0, p.jsx)(T, {}),
                    l = r ? (0, p.jsx)(k, {}) : null,
                    o = n ? (0, p.jsx)(S, {}) : null,
                    i = n || r || !t ? null : (0, p.jsx)(O, { char: t });
                  return (0, p.jsxs)("div", {
        ...
        O = function (e) {
          var t = e.char,
            ...
            u = { objectFit: "cover" };
          return (
            a.search(/image_not_available/i) && (u = { objectFit: "contain" }),
            (0, p.jsxs)(p.Fragment, {
              children: [
                (0, p.jsxs)("div", {
                  className: "char__basics",
                  children: [
                    (0, p.jsx)("img", { src: a, alt: n, style: u }),
                    (0, p.jsxs)("div", {
                      children: [
                        (0, p.jsx)("div", {
                ...
                (0, p.jsx)("div", { className: "char__descr", children: r }),
                (0, p.jsx)("div", {
        ...
        R = function (e) {
          return 0 === e.comics.length
            ? (0, p.jsx)("li", {
                className: "char__comics-item",
                children: "not found comics",
              })
            : e.comics.map(function (e, t) {
                if (!(t > 9))
                  return (0, p.jsx)(
                    "li",
        ...
        F = z,
        M = n.p + "static/media/vision.067d4ae1936d64a577ce.png",
        I = (function (e) {
          s(n, e);
          var t = d(n);
          function n() {
            ...
            for (var a = arguments.length, l = new Array(a), o = 0; o < a; o++)
              l[o] = arguments[o];
            return (
              ((e = t.call.apply(t, [this].concat(l))).state = { error: !1 }), e
            );
          }
          return (
            i(n, [
              {
                ...
                value: function (e, t) {
                  console.log(e, t), this.setState({ error: !0 });
                },
              },
              {
                key: "render",
        ...
        U = (function (e) {
          ...
          function n(e) {
            ...
            return (
              r(this, n),
              ((a = t.call(this, e)).onCharSelected = function (e) {
                console.log(e), a.setState({ selectdChar: e });
              }),
              (a.state = { selectdChar: null }),
              a
            );
          }
          return (
      ...
      t.createRoot(document.getElementById("root")).render((0, p.jsx)(U, {}));
    })();
})();
